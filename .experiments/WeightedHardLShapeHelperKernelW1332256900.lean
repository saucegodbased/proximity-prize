...
/-!
# Joint helper kernel and generic hard-L-shape escape at W=133225
...
-/
namespace ProximityPrize.SubmissionLower.WeightedHardLShapeHelperKernelW1332256900
...
open WeightedCutoff2TargetW1332256900 WeightedCutoff2ColumnsW1332256900
...
def kernelLower : Nat := 133651239658485317
...
def helperPolynomialKernel (I : Type*) [Fintype I]
  ...
  polynomialKernel K I htwo 11810 2130677530 133225
...
theorem helperPolynomialKernel_le_box (I : Type*) [Fintype I]
  ...
  simpa only [helperPolynomialKernel,sourceCutoff,wordDegree,derivativeCap,
    Nat.reduceMul] using
      polynomialKernel_le_box K I htwo 11810 2130677530 133225
        1312 (by norm_num) nodes values

/-- Exact dimension receipt:

`82571974525432451177 - 262143*314478446061020
  = 133651239658485317`.
-/
theorem helperPolynomialKernel_dimension
  ...
  have hproduct : Fintype.card I*
      Module.finrank K (totalTarget K 11810 15993 1312)≤
        262143*314478446061020 := Nat.mul_le_mul hn hr
  have hsource := helper_columns_lower
  have hbudget :
      133651239658485317≤columns 2130677530 133225 5248-
        Fintype.card I*
...
theorem kernel_arithmetic_receipt :
    82571974525432451177-262143*314478446061020=kernelLower ∧
...
end ProximityPrize.SubmissionLower.WeightedHardLShapeHelperKernelW1332256900
