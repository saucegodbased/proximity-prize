import WeightedPrimary547KernelW1332256900
import Order2SourceSpecializationScaffold

/-! Universal vanishing produced by the exact hard W=133225 primary source. -/
namespace ProximityPrize.SubmissionLower.WeightedPrimary547UniversalW1332256900
...
theorem primary_universal_vanishing {K I : Type*} [Field K] [Fintype I]
    ...
    (hn : Fintype.card I≤262143) (h2 : (2 : K)≠0) :
    ∃ Q : Poly4 K, Q≠0 ∧ Q∈weightedCoefficientBox K 98685911 133225 244 ∧
  ...
  obtain ⟨Q,hQ,hweighted,hcaps,hcontact⟩ :=
    WeightedPrimary547KernelW1332256900.primary_source_exists
  ...
  apply localJetSpecialization2_eq_zero_of_contact_and_degree
    Q P nodes values support 547 hinj.injOn h2
  · intro i hi
    exact hcontact i
  · exact hvalues
  · have hdegree := localJetSpecialization2_natDegree_lt
      98685911 133225 740 244 122 Q P (by norm_num) hcaps hP
    have hmany : 98685911≤547*support.card := by omega
    exact hdegree.trans_le hmany

#print axioms primary_universal_vanishing

end
end ProximityPrize.SubmissionLower.WeightedPrimary547UniversalW1332256900
